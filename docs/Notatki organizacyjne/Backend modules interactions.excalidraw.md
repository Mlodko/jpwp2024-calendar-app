...
```json
{
	...
	"elements": [
		...
		},
		{
			...
			"opacity": 100,
			"angle": 0,
			"x": 1539.4290378979952,
			"y": 317.13512792815015,
			"strokeColor": "#1e1e1e",
			"backgroundColor": "transparent",
			"width": 135.9367850398014,
			"height": 90.82730549848463,
			"seed": 1978896387,
			"groupIds": [],
			"frameId": null,
			"roundness": {
		...
		},
		{
			...
			"opacity": 100,
			"angle": 0,
			"x": 459.66504584418414,
			"y": 787.0321721879261,
			"strokeColor": "#1e1e1e",
			"backgroundColor": "transparent",
			"width": 197.93978881835938,
			"height": 25,
			"seed": 1607818768,
			"groupIds": [],
			"frameId": null,
			"roundness": null,
			"boundElements": [],
			"updated": 1711997665350,
			"link": null,
			"locked": false,
			"fontSize": 20,
			"fontFamily": 1,
			"text": "worskpace_name.ical",
			"rawText": "worskpace_name.ical",
			"textAlign": "center",
			"verticalAlign": "middle",
	...
	"appState": {
		...
		"scrollX": 260.02219988874344,
		"scrollY": 489.96597407387867,
		"zoom": {
			"value": 0.4
		},
